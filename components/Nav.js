...
export default function Nav({ show }) {
  ...
  const activeLink = inactiveLink + " bg-white text-stone-900 rounded-lg";
  const inactiveIcon = "w-6 h-6 ";
  const activeIcon = inactiveIcon + " text-stone-900";
  ...
  return (
    <aside
      className={
        ...
        " top-0 text-white p-4 fixed w-full bg-stone-900 h-full md:static md:w-auto transition-all "
      }
    >
      ...
      <nav className="flex flex-col gap-2">
        ...
        <button onClick={logOut} className={inactiveLink + " cursor-pointer"}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
